          ...
          <div className="flex-1 min-h-0 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden relative">
            ...
            <div className="absolute top-4 left-4 z-10 flex gap-2">
              <button
                ...
                className={`px-3 py-2 rounded-lg text-sm font-bold transition-all shadow-lg backdrop-blur-md ${
                  viewMode === 'stylized'
                    ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white ring-2 ring-purple-300' 
                    : 'bg-white/90 text-gray-700 hover:bg-white'
                }`}
                title="Stylized: Tampilan artistik untuk presentasi konsep"
              >
                <div className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4" />
                  <span className="hidden sm:inline">Stylized</span>
                </div>
              </button>
              ...
              <button
                ...
                title="Realized: Render photorealistic untuk produksi"
              >
                <div className="flex items-center gap-2">
                  <Box className="w-4 h-4" />
                  <span className="hidden sm:inline">Realized</span>
                </div>
              </button>
            </div>
            
            {/* Auto Rotate - Top Right */}
