          ...
          <div className="max-w-md mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none lg:gap-5">
            ...
            <div className="flex flex-col rounded-lg shadow-lg overflow-hidden border border-gray-200">
              <div className="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                <div>
                  <h3 className="inline-flex px-4 py-1 rounded-full text-sm font-semibold tracking-wide uppercase bg-slate-100 text-slate-600">
                    Starter
                  </h3>
                </div>
              ...
              <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                ...
                <div className="rounded-md shadow">
                  <Link to="/projects" className="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-slate-600 bg-white hover:bg-gray-50 border-slate-200">
                    Mulai Gratis
                  </Link>
                </div>
              </div>
            ...
            {/* Pro Plan */}
            <div className="flex flex-col rounded-lg shadow-xl overflow-hidden border-2 border-slate-500 relative transform scale-105 z-10">
              ...
              <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                ...
                <div className="rounded-md shadow">
                  <Link to="/projects" className="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-slate-600 hover:bg-slate-700">
                    Mulai Trial 14 Hari
                  </Link>
                </div>
              </div>
            ...
            <div className="flex flex-col rounded-lg shadow-lg overflow-hidden border border-gray-200">
              ...
              <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                ...
                <div className="rounded-md shadow">
                  <Link to="/" className="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-slate-600 bg-white hover:bg-gray-50 border-slate-200">
                    Hubungi Sales
                  </Link>
                </div>
              </div>
